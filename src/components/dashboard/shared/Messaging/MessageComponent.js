...
const MessageComponent = ({ courseId }) => {
  ...
  return (
    <Grid
      style={{ width: "50%", minWidth: "350px", marginLeft: "25%" }}
      container
      direction="column"
      alignItems="stretch"
      justify="flex-end"
    >
      <div>
        ...
        <h1 className="text-lg font-semibold text-gray-600">Messaging</h1>
      </div>
      <Grid item xs={12}>
        ...
        <Paper className="p-4">
          <Scrollbars style={{ height: "350px" }} ref={scrollbarsRef}>
      ...
      <Grid item xs={12} className="mt-4">
        <Grid container alignItems="center">
          ...
          <Grid item xs={2} style={{ textAlign: "center" }}>
            <Button variant="text" color="primary" onClick={handleSendMessage}>
              Send
            </Button>
          </Grid>
        </Grid>
